...
function countRecordsAndDisplay() {
  ...
  recordsContainer.appendChild(createCard("Available for Request", confirmedDonations.length, "fas fa-check-circle"));
  recordsContainer.appendChild(createCard("Available for Pick-up", requestedDonations.length, "fas fa-exclamation-circle"));
  recordsContainer.appendChild(createCard("Picked Up Donations", pickedUpDonations.length, "fas fa-truck"));
}
